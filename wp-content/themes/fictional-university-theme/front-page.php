...
<div class="page-banner">
	...
	<div class="page-banner__content container t-center c-white">
		<h1 class="headline headline--large">Welcome Everyone!!</h1>
			...
			<?php while($homepagePosts->have_posts()): $homepagePosts->the_post(); ?>
				<div class="event-summary">
					...
					<div class="event-summary__content">
						...
						<p><?php if(has_excerpt()){echo get_the_excerpt();}else{echo wp_trim_words(get_the_content(), 12);}?> <a href="<?php the_permalink();?>" class="nu gray">Read more</a></p>
					</div>
				</div>
			<?php endwhile; wp_reset_postdata(); ?>
